...
<div id="wrapper">
    ...
    <div class="header">
	        ...
	        <?php else : ?>
				<h1 class="site-title"><a href="<?php echo home_url( '/' ); ?>" style="color:rgba(111, 111, 182, 0.39); text-transform:none; text-decoration:none; -webkit-mask-image: -webkit-gradient(linear, left top, left bottom, from(#00f), to(rgba(0,0,0,0.3))); text-shadow: 0 2px 2px rgba(0,0,0,0.4);"><?php bloginfo( 'name' ); ?></a></h1>
	        <?php endif; ?>
				<span class="site-description" style="color:rgba(151, 160, 170, 1); text-transform:none; text-decoration:none; -webkit-mask-image: -webkit-gradient(linear, left top, left bottom, from(#00f), to(rgba(0,0,0,0.3))); text-shadow: 0 1px 1px rgba(0,0,0,0.25);"><?php bloginfo( 'description' ); ?></span>
